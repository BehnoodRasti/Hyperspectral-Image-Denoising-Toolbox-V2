...
[HSI-DIP](https://github.com/acecreamu/deep-hs-prior). However, it is enough to download the original [DIP](https://github.com/DmitryUlyanov/deep-image-prior) toool box and copy the python file into the master folder (change the path to the mat file) and run. Addtionally, you need to install the dependencies (see [readme](https://github.com/DmitryUlyanov/deep-image-prior)) 
