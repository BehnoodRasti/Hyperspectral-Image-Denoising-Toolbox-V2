...
[DIP](https://github.com/DmitryUlyanov/deep-image-prior), and [SDeCNN](https://github.com/mhaut/HSI-SDeCNN). For SDeCNN, only replace the Indian.mat which has 206 bands with one which we used with 220 bands (The link is given below).
